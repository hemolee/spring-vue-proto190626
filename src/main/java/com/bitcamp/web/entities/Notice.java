...
public class Notice implements Serializable{
    ...
    private Long id;
    @Column(name="wtd_seq_no") private String noticeNumber;
    ...
    @Column(name="sysdate")private String sysdate ;
    ...
    public String toString(){
        return String.format("고객정보 No: %d|n" + "ID: %s", noticeNumber, title,
        content1,content2,content3,content4,state,career,industry,start_date,last_dates,
        sysdate,tag1,tag2,tag3);
    }

    @Builder
    private Notice(String noticeNumber, String title,String content1, String content2,String content3,
    String content4,String state,String career,String industry, String start_date, String last_dates,
    String sysdate, String tag1,String tag2,String tag3){
